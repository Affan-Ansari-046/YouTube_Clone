...
const PlayVideo = ({}) => {
    ...
    const fetchChannelData = async ()=>{
        ...
        await fetch(channelDetailsUrl).then(res=>res.json()).then(data=>setChannelData(data.items[0]))

        //here we are fetching comment data
  ...
  return (
    <div className='play-video'>
        ...
        <div className='play-video-info'>
            <p>{apiData?value_converter(apiData.statistics.viewCount):"10"} views &bull; {apiData?moment(apiData.snippet.publishedAT).fromNow():" "}</p>
            <div>
        ...
        <div className='publisher'>
            ...
            <div>
                ...
                <span>{channelData?value_converter(channelData.statistics.subscriberCount):10} Subscribes</span>
            </div>
        ...
        <div className='vid-description'>
            ...
            {commentData.map((item,index)=>{
                ...
                <div>
                    <h3>{item.snippet.topLevelComment.snippet.authorDisplayName.slice(1,)} <span>2 days ago</span></h3>
